...
class GazeOverlay(QtWidgets.QWidget):
    def __init__(self, model1, scaler1, model2, scaler2, model3, scaler3, model4, scaler4):
        super().__init__()
        self.model1 = model1
    ...
    def update_gaze(self):
        try:
            ...
            x_c, y_c = grid_center(y1_majority, y2_majority, x1_majority, x2_majority)
            self.est_x = x_c
            self.est_y = y_c
...
if __name__ == "__main__":
    ...
    overlay = GazeOverlay(model1, scaler1, model2, scaler2, model3, scaler3, model4, scaler4)
